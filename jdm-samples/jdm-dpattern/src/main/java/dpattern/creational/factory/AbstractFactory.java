 ...
 */
package dpattern.creational.factory;

import dpattern.creational.factory.color.ColorFactory;
import dpattern.creational.factory.color.ColorInterface;
import dpattern.creational.factory.shape.ShapeFactory;
 ...
 * 又称为其他工厂的工厂。这种类型的设计模式属于创建型模式，它提供了一种创建对象的最佳方式。
 *
