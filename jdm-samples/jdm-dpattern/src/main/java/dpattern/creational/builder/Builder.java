...
import dpattern.creational.builder.burger.ChickenBurgerItem;
import dpattern.creational.builder.burger.VegBurgerItem;
import dpattern.creational.builder.drink.CokeDrink;
import dpattern.creational.builder.drink.PepsiDrink;

/**
 * 建造者模式
 *
 * 建造者模式（Builder Pattern）使用多个简单的对象一步一步构建成一个复杂的对象。这种类型的设计模
